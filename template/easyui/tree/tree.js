...
define(function(require, exports, module){
	...
	require("droppable");
	require("parser");
    require.async("style-module/tree.css");
    /**
     * jQuery EasyUI 1.3.5
     * 
...
define("expand_tree",function(require, exports, module){
	$.extend($.fn.tree.methods.synchronized,function ( jq , nd ){
		var od = $.data(jq[0],"tree").options.data;
		this._sync(nd,od,"state");
		return jq.tree("loadData",nd);
	});
	$.extend($.fn.tree.methods._sync,function (n,o,state) {
		if ("[object Object]" == Object.prototype.toString.call(n)) {
			n[state] = o[state] ? o[state] : "closed";
			for (p in n) {
				arguments.callee(n[p],o[p],state);
			}
		} else if ("[object Array]" == Object.prototype.toString.call(n)) {
			var i = 0;
		    var len = n.length;
		    for (;i<len;i++) {
		    	arguments.callee(n[i],o[i],state);
		    }
		}
	});
});
