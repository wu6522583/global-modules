...
define(function(require, exports, module){
	require("panel");
	require("linkbutton");
    require.async("style-module/tabs.css");
    /**
     * jQuery EasyUI 1.3.5
     * 
    ...
    require("template/easyui/tabs/expand_tabs");
});
define("template/easyui/tabs/expand_tabs",function(require, exports, module){
	$.extend($.fn.tabs.methods.addTabs , function ( jq , _o) {
        if (this.options(jq).size && this.tabs(jq).length >= this.options(jq).size) {
            this.close( jq , 0 );
        }
        return this.add( jq , _o );
    });
});
